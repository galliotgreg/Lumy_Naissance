...
Shader "Nature/Terrain/Custom" {
    ...
    SubShader {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
            ...
            float3 defaultHeight = tex2D(_Splat3, IN.uv_Splat3).rgb;
            float3 defaultMetallic = float3(_Metallic0,_Metallic1,_Metallic2);

            SplatmapMix(IN, defaultSmoothness, splat_control, weight, mixedDiffuse, o.Normal, defaultHeight, defaultMetallic);
