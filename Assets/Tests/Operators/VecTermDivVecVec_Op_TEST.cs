...
public class VecTermDivVecVec_Op_TEST : MonoBehaviour
{
    [SerializeField]
    ...
    private void RandomizeTest()
    {
        ...
        AB_Vec_TermDiv_Vec_Vec_Operator ope = (AB_Vec_TermDiv_Vec_Vec_Operator)ABOperatorFactory.CreateOperator(symbol);
