...
class BoolRefEqualsRefRef_Op_TEST : MonoBehaviour{
    ...
    private void RandomizeTest() {
        ...
        AB_Bool_RefEquals_Ref_Ref_Operator ope = (AB_Bool_RefEquals_Ref_Ref_Operator)ABOperatorFactory.CreateOperator(symbol);
