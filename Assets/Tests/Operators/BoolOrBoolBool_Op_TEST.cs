...
public class BoolOrBoolBool_Op_TEST : MonoBehaviour
{
    ...
    private void Test(bool b1, bool b2)
    {
        ...
        AB_Bool_Or_Bool_Bool_Operator ope = (AB_Bool_Or_Bool_Bool_Operator)ABOperatorFactory.CreateOperator(symbol);
