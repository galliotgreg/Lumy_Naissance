...
public class BoolNotEqualsScalScal_Op_TEST : MonoBehaviour
{
    [SerializeField]
    ...
    private void RandomizeTest()
    {
        ...
        AB_Bool_NotEquals_Scal_Scal_Operator ope = (AB_Bool_NotEquals_Scal_Scal_Operator)ABOperatorFactory.CreateOperator(symbol);
