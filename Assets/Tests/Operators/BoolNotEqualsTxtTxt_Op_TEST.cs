...
class BoolNotEqualsTxtTxt_Op_TEST : MonoBehaviour{
    ...
    private void Test(string t1, string t2) {
        ...
        AB_Bool_NotEquals_Txt_Txt_Operator ope = (AB_Bool_NotEquals_Txt_Txt_Operator)ABOperatorFactory.CreateOperator(symbol);
