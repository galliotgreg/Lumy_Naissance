...
public class ScalSumScalScal_Op_TEST : MonoBehaviour {
    [SerializeField]
    ...
    private void RandomizeTest()
    {
        ...
        AB_Scal_Sum_Scal_Scal_Operator ope = (AB_Scal_Sum_Scal_Scal_Operator) ABOperatorFactory.CreateOperator(symbol);
