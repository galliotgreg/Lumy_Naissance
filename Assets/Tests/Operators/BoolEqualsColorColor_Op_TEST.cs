...
public class BoolEqualsColorColor_Op_TEST : MonoBehaviour
{
    [SerializeField]
    ...
    private void EqualTest()
    {
        ...
        AB_Bool_Equals_Color_Color_Operator ope = (AB_Bool_Equals_Color_Color_Operator)ABOperatorFactory.CreateOperator(symbol);
