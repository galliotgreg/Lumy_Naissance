...
class RefTabWhereEqualsRefTabTxtRef_Op_TEST : MonoBehaviour {
    ...
    private void RandomizeTest() {
        ...
        AB_RefTab_WhereEquals_RefTab_Txt_Ref_Operator ope = (AB_RefTab_WhereEquals_RefTab_Txt_Ref_Operator)ABOperatorFactory.CreateOperator(symbol);
