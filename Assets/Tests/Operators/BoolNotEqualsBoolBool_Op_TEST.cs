...
public class BoolNotEqualsBoolBool_Op_TEST : MonoBehaviour
{
    [SerializeField]
    ...
    private void Test(bool b1, bool b2)
    {
        ...
        AB_Bool_NotEquals_Bool_Bool_Operator ope = (AB_Bool_NotEquals_Bool_Bool_Operator)ABOperatorFactory.CreateOperator(symbol);
