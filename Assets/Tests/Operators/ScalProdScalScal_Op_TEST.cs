...
public class ScalProdScalScal_Op_TEST : MonoBehaviour
{
    [SerializeField]
    ...
    private void RandomizeTest()
    {
        ...
        AB_Scal_Prod_Scal_Scal_Operator ope = (AB_Scal_Prod_Scal_Scal_Operator)ABOperatorFactory.CreateOperator(symbol);
