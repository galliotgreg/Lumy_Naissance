...
public class ScalSubScalScal_Op_TEST : MonoBehaviour
{
    [SerializeField]
    ...
    private void RandomizeTest()
    {
        ...
        AB_Scal_Sub_Scal_Scal_Operator ope = (AB_Scal_Sub_Scal_Scal_Operator)ABOperatorFactory.CreateOperator(symbol);
