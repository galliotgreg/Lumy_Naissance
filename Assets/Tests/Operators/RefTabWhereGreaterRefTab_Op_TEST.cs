...
class RefTabWhereGreaterRefTab_Op_TEST : MonoBehaviour {
    ...
    private void RandomizeTest() {
        ...
        AB_RefTab_WhereLess_RefTab_Txt_Scal_Operator ope = (AB_RefTab_WhereLess_RefTab_Txt_Scal_Operator)ABOperatorFactory.CreateOperator(symbol);
