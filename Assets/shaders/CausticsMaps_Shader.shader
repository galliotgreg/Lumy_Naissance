...
////// Lighting:
////// Emissive:
                float4 node_8831 = _Time + _TimeEditor;
                float2 node_5577 = (i.uv0+node_8831.g*float2(0.015,0.015));
                ...
                float3 emissive = ((((node_1860.rgb-(1.0 - _Thickeness))*_Opacity)*i.vertexColor.a)*_node_7252.rgb);
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float2 node_5577 = (i.uv0+node_5901.g*float2(0.015,0.015));
                float4 _node_199_var = tex2D(_node_199,TRANSFORM_TEX(node_5577, _node_199));
                float2 node_9302 = ((_node_199_var.g*0.05+0.0)+(i.uv0*0.35));
                float4 node_1860 = tex2D(_node_296,TRANSFORM_TEX(node_9302, _node_296));
                o.Emission = ((((node_1860.rgb-(1.0 - _Thickeness))*_Opacity)*i.vertexColor.a)*_node_7252.rgb);
