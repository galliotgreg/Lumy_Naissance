...
////// Emissive:
                ...
                float3 emissive = (node_3679.a*(saturate((min(pow((1.0 - pow(1.0-max(0,dot(normalDirection, viewDirection)),_node_8632)),5.0),(pow(1.0-max(0,dot(normalDirection, viewDirection)),_node_8632_copy)*node_3679.rgb*(node_3679.a*_node_2697)))*1.4))*i.vertexColor.rgb*_Color.rgb*1.5*i.vertexColor.a));
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float2 node_165 = (i.uv0+((node_5533.g*0.05)*float2(_x,_y)));
                float4 node_3679 = tex2D(_node_5782,TRANSFORM_TEX(node_165, _node_5782));
                o.Emission = (node_3679.a*(saturate((min(pow((1.0 - pow(1.0-max(0,dot(normalDirection, viewDirection)),_node_8632)),5.0),(pow(1.0-max(0,dot(normalDirection, viewDirection)),_node_8632_copy)*node_3679.rgb*(node_3679.a*_node_2697)))*1.4))*i.vertexColor.rgb*_Color.rgb*1.5*i.vertexColor.a));
