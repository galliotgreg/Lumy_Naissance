...
////// Lighting:
////// Emissive:
                float4 node_9558 = _Time + _TimeEditor;
                float2 node_9750 = (i.uv0+node_9558.g*float2(0.35,0.2));
