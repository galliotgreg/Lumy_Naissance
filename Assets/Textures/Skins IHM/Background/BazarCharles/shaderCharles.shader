...
////// Emissive:
                ...
                float3 emissive = (lerp(_A.rgb,_B.rgb,saturate(sin(((node_3432.r+(node_5932.g*0.2))*0.71))))*clamp(length((i.uv0*1.0+0.0)),abs(sin((node_3227.g*0.1))),1.0));
