...
////// Emissive:
                ...
                float3 emissive = (lerp(_A_copy.rgb,_B_copy.rgb,saturate(sin(((node_3432.r+(node_5932.g*0.4))*0.7))))*clamp(length((i.uv0*1.0+0.0)),abs(sin((node_3227.g*0.1))),0.7));
